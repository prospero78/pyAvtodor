...
class клсМеню(Фрейм):
   def __init__(сам, предок, якорь):
      ...
      мнуФайл.add_cascade(label=рес.окноГлавное_мнуВыход, command = обр.Выход)
      ...
      мнуНастройка.add_cascade (label=рес.окноГлавное_мнуСмт_Уст, command=обр.СМТ_Уст)
      мнуНастройка.add_separator()
      мнуНастройка.add_cascade (label=рес.окноГлавное_мнуАвто_Уст, command=обр.Авто_Уст)
      мнуНастройка.add_separator()
      ...
      мнуСправка.add_cascade(label=рес.окноГлавное_мнуО_Программе, command = обр.О_Программе_Показать)
