# coding: utf8
"""
Содержит рамку с командами на добавление автомобиля в список известных
"""
...
class клсРамкаКоманды(клсРамка):
	def __init__(сам, предок, якорь):
		...
		# TODO: заменить русские строки ссылками на файл ресурсов
		сам.кнпНовая = клсКнопка(сам, text="Добавить", border=2, command=обр.соб.АвтоНов_Добавить)
